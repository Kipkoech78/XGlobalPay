    ...
    <div className="min-h-screen  w-340 flex items-center justify-start bg-white">
      <div className="flex w-full   shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="w-1/2 lg:p-40 sm:p-12 bg-[#b4002f] text-white flex flex-col items-center justify-center ">
          ...
          <button className="border-2 border-white text-white py-4 px-18 mb-4 hover:bg-white hover:text-[#b4002f] transition">
            Sign In
          </button>
        
          <Link to='/auth/register'>
          <button className="border-2 border-white text-white py-4 px-18 hover:bg-white hover:text-[#b4002f] transition">
            Sign Up
          </button>
          </Link>
        </div>
